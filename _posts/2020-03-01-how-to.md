...
5. `format:list` will change the layout to a list with border, Refer [[_notes/Private/Credits]]. This is useful for Curated lists (Check [my personal library](https://hiran.in/list/reading) ) or while building MoC. 
