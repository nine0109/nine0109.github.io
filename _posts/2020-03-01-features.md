...
###### Markdown support
The theme supports all standard markdowns. Have a look at [[_notes/Private/Markdown Rendered]] to see preview.
...
With simple front matter configuration, you can build a list layout (Check [[_notes/Private/Credits]] for demo). This is helpful for building manual MoC :) 
